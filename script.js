...
function update() {
  ...
  element.style = 'margin: 3% 0; color: initial; font-family: initial;'
  element.id = 'element'
  ...
  function dropdown(attribute, options, norm=options[0], isStyle=true) {
  ...
  dropdown('justify-content', ['felx-start', 'flex-end', 'center', 'initial', 'inherit'], 'center')
